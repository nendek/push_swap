...
void					ft_sa_list(int *pile_a, int i_a,\
		t_cmd_list **list);
void					ft_sb_list(int *pile_b, int i_b,\
		t_cmd_list **list);
void					ft_ra_list(int *pile_a, int i_a,\
		t_cmd_list **list);
void					ft_rb_list(int *pile_b, int i_b,\
		t_cmd_list **list);
void					ft_rra_list(int *pile_a, int i_a,\
		t_cmd_list **list);
void					ft_rrb_list(int *pile_b, int i_b,\
		t_cmd_list **list);
void					ft_pa_list(t_pile pile, int *last_a,\
		int *last_b, t_cmd_list **list);
void					ft_pb_list(t_pile pile, int *last_b,\
		int *last_a, t_cmd_list **list);
void					ft_rr_list(t_pile pile, int last_a,\
		int last_b, t_cmd_list **list);
void					ft_rrr_list(t_pile pile, int last_a,\
		int last_b, t_cmd_list **list);
...
void					ft_pa_sim(t_pile pile, int *last_a,\
		int *last_b, int *nb_coup);
void					ft_pb_sim(t_pile pile, int *last_b,\
		int *last_a, int *nb_coup);
void					ft_rr_sim(t_pile pile, int last_a,\
		int last_b, int *nb_coup);
void					ft_rrr_sim(t_pile pile, int last_a,\
		int last_b, int *nb_coup);
